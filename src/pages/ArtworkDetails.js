...
import projectDetailsData from "../artworkDetailsData.js";
          ...
          <div className={styles.project}>
              ...
              <div className={styles.info}>
                ...
                <div className={styles.desc}>
                  <div className={styles.desc1}>
                    <div className={styles.descSub}>MEDIUM</div>
                    {info.role.join(", ")}
                  </div>
                  <div className={styles.desc1}>
            ...
            >
              <img
                ...
                alt="Back"
              />
              <div className={styles.viewLinkButtonText}> BACK TO ARTWORKS</div>
            </NavLink>
          </div>
        )}
      </div>
